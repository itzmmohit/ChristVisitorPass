...
const authController = require('../controllers/fauth');
const userController = require('../controllers/fuserController');
const router = express.Router();

//change the below urls of router.get to /faculty/given_value later
...
router.get('/register', (req,res) => {
    res.render('fregister'); //this will render register.hbs file when we go to /register url
});

router.get('/login', (req,res) => {
    res.render('flogin'); //this will render register.hbs file when we go to /register url
});
